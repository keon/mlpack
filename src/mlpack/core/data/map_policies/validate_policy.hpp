...
class ValidatePolicy
{
 public:
  ...
  //using MAppedObjectType = std::vector<size_t>; // vector of points;
                       ...
                       const bool invalid = false)
  {
    ...
    if (invalid)
    {
      ...
      //std::vector<size_t>& pointVectors = maps[dimension].first.left.at(string);
      //pointVectors.push_back(point)
